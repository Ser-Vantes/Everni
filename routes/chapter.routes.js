...
module.exports = function (app) {
    ...
    app.patch("/api/chapter/addLecture/:id", [authJwt.verifyToken], controller.addChapterLecture);
    app.patch("/api/chapter/deleteLecture/:id", [authJwt.verifyToken], controller.deleteChapterLecture);
    app.patch("/api/chapter/addTask/:id", [authJwt.verifyToken], controller.addChapterTask);
    app.patch("/api/chapter/deleteTask/:id", [authJwt.verifyToken], controller.deleteChapterTask);
