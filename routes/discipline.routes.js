...
module.exports = function (app) {
    ...
    app.patch('/api/disciplines/deleteStudent/:id', [authJwt.verifyToken,authJwt.isAdmin], controller.deleteStudent)
    app.patch('/api/disciplines/addChapter/:id', [authJwt.verifyToken,authJwt.isAdmin], controller.addDisciplineChapter)
    app.patch('/api/disciplines/deleteChapter/:id', [authJwt.verifyToken,authJwt.isAdmin], controller.deleteDisciplineChapter)
